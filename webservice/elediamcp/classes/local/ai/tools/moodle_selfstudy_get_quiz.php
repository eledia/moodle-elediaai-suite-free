...
class moodle_selfstudy_get_quiz implements ai_tool {
    ...
    public static function execute(array $arguments, stdClass $user): array {
        ...
        try {
            $quiz = \local_elediaai_selfstudy\local\quiz_service::get_owned($quizid, (int) $user->id);
        } catch (moodle_exception $ex) {
            throw selfstudy_helper::map_exception($ex);
        }
        $questions = \local_elediaai_selfstudy\local\quiz_service::questions($quizid, false);
