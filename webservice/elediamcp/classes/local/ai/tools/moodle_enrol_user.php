...
class moodle_enrol_user implements ai_tool {
    ...
    public static function execute(array $arguments, stdClass $user): array {
        ...
        $assignable = get_assignable_roles($coursecontext, ROLENAME_SHORT, false, $user->id);
        if (!array_key_exists((int) $role->id, $assignable)) {
            throw new tool_exception('You are not allowed to assign this role.', [
