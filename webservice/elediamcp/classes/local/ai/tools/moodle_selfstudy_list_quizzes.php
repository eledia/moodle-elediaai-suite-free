...
class moodle_selfstudy_list_quizzes implements ai_tool {
    ...
    public static function description(): string {
        return 'Lists the authenticated user\'s personal self-study quizzes, newest first, with '
            . 'attempt counts and best scores. Use this only when the user asks to list, continue, '
            . 'review or reopen existing practice quizzes. Do NOT use this before creating a new '
            . 'quiz; an empty list does not mean creation is impossible. Optionally filtered by '
            . 'course. Use the quiz_id with moodle_selfstudy_get_quiz to fetch questions.';
    }
    ...
    public static function execute(array $arguments, stdClass $user): array {
        ...
        $quizzes = \local_elediaai_selfstudy\local\quiz_service::list_for_user((int) $user->id, $courseid, $limit);
