...
class moodle_create_course implements ai_tool {
    ...
    public static function title(): string {
        return 'Create an empty Moodle course';
    }
    ...
    public static function description(): string {
        return 'Creates an EMPTY Moodle course in a course category -- sections, no content. '
            . 'If the teacher wants the course filled with activities as well, use '
