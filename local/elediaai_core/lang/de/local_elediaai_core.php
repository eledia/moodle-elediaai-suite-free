...
$string['launcher_heading'] = 'Übersicht der KI-Suite';
...
$string['feature_status_locked'] = 'Nicht lizenziert';
$string['feature_locked_hint'] = 'Nicht Teil der Lizenz dieser Website.';
...
$string['feature_coursegen_install_desc'] = 'Installieren Sie den eLeDia.ai-Kursautor, um aus einem Steckbrief vollständige Kurse zu entwerfen: Abschnitte, Aktivitäten und Lernziele.';
...
$string['showplaceholders'] = 'Nicht installierte Funktionen als Vorschau zeigen';
$string['showplaceholders_desc'] = 'Zeigt Kacheln für Funktionen der Suite, die auf dieser Website nicht installiert sind („In Vorbereitung", „Installierbar"). Sinnvoll auf Demo- und Vertriebsinstanzen; auf Kundensystemen ausgeschaltet lassen, dort kündigen diese Kacheln Werkzeuge an, die es nicht gibt. Installierte Premium-Funktionen außerhalb der Lizenz erscheinen immer, gekennzeichnet als nicht lizenziert.';
